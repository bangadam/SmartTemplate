            ...
            <li class="dropdown">
              ...
              <div class="dropdown-menu">
                <ul>
                  ...
                  <li><a href="sarpras.php">Sarana & Prasarana</a></li>
                  <li><a href="tata_tertib.php">Tata Tertib</a></li>
                </ul>
              </div>
            </li>
            <li class="dropdown">
              ...
              <div class="dropdown-menu">
                <ul>
                  ...
                  <li><a href="extra.php">Extra Kurikuler</a></li>
                </ul>
              </div>
            </li>
            <li><a href="blog-left-sidebar.php">Berita</a></li>
            <li><a href="event.php">Event</a></li>
            <li><a href="gallery.php">Galeri</a></li>
            <li><a href="ebook.php">E-book</a></li>
            <li><a href="komite.php">Komite Sekolah</a></li>
            <li><a href="contact.php">Kontak</a></li>
            <li><a href="login.php" target="_blank">Daftar</a></li>
          </ul>
        </div>
      </nav>
      <!-- /main nav -->
